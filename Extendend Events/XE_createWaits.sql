CREATE EVENT SESSION [SQL Waits] ON SERVER 
ADD EVENT sqlos.wait_info 
(    -- Capture the database_id, session_id, plan_handle, and sql_text
    ACTION(sqlserver.database_name,sqlserver.session_id,sqlserver.sql_text,sqlserver.plan_handle)
    WHERE
...
ADD TARGET package0.event_file(SET filename=N'd:\ac\SQL_Waits',max_file_size=(500))
